<div class="cms-content-tools east cms-panel cms-panel-layout block-admin-sidebar<% if $isOpen %> open<% end_if %>" data-expandOnClick="true" data-layout-type="border" id="blog-admin-sidebar">
